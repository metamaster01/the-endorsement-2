...
//           <motion.div  className="lg:col-span-3 flex items-start">
...
//           <motion.div  className="lg:col-span-9 space-y-6">
...
//             <motion.p className="text-base sm:text-lg text-gray-900 max-w-4xl leading-relaxed">
...
//           <motion.div className="relative w-full h-80 md:h-auto rounded-2xl overflow-hidden">
...
const AboutSection = () => {
  ...
  // ✅ Memoized words so they don't change every render
  const words = useMemo(
    () => ["About Us", "Our Vision", "Our Mission", "About Us"],
    []
  );
  ...
  return (
    <div
      className="min-h-screen bg-white py-16 px-4 sm:px-6"
      id="about"
      ref={sectionRef}
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div className="lg:col-span-9 space-y-6">
            ...
            <motion.p className="text-base sm:text-lg text-gray-900 max-w-4xl leading-relaxed">
              The Endorsement Co. is a premier celebrity and influencer
              marketing agency, founded as a subsidiary of Elohim Film
              Production, a leading film production company. Together, we bridge
              the worlds of entertainment and marketing, offering unparalleled
              access to celebrity talent and influencer networks.
            </motion.p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {cards.map((card, index) => (
              <CardWithGlow key={index} card={card} />
            ))}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch"
        >
          <motion.div className="bg-v0yellow text-black rounded-2xl p-8 flex flex-col justify-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Story</h2>
            <p className="text-base leading-relaxed mb-4">
              Born from the creative powerhouse of Elohim Film Production, The
              Endorsement Co. bridges the gap between authentic storytelling and
              strategic brand marketing. Our parent company&apos;s legacy in
              film production gives us unparalleled access to talent and
              industry insights.
            </p>
            <p className="text-base leading-relaxed">
              Our unique position in the entertainment ecosystem allows us to
              create campaigns that feel natural, engaging, and drive real
              business impact for brands across FMCG, fashion, technology,
...
// ✅ Extracted card into its own component so hooks are valid
const CardWithGlow = ({ card }) => {
  const [isHovered, setIsHovered] = useState(false);
  const [mousePos, setMousePos] = useState({ x: 0, y: 0 });
